...
public class ForgotPasswordController {
  ...
  public EmailService emailService;
	...
	private void sendEmail(String link, String email) throws UnsupportedEncodingException, MessagingException {
	    ...
	    //String subject1 = "[Medical Center] link to reset your password";
	    ...
	    try {
	        ...
	        emailService.sendMessageUsingThymeleafTemplate(email, "[MedicalCenter] link to reset your password", templateModel); // Thay đổi địa chỉ email người nhận
	    } catch (IOException e) {
	        e.printStackTrace();
