...
public class SecurityConfiguration {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests((authorize) -> authorize.requestMatchers("/users/**", "roles/**")
				...
				.requestMatchers("/apis/v1/signin","/apis/v1/signup", "/apis/test/**", "/forgot_password", "/reset_password", "/register", "/" , "/files/**", "/blogsgrid/**",
						"/doctorinfosgrid/**","/specialtiesgrid/**", "/apis/v1/blogsgrid", "/apis/v1/specialtiesgrid", 
						"/apis/v1/doctorinfosgrid", "/apis/v1/contactus","/apis/v1/profile","appointments/new","contactus/new","scheduleofdoctor/schedule-items/**","/appointments/save/order/**",
						"/apis/v1/appointmentUserLogin/list","/apis/v1/appointmentUserLogin/newAppointment","/apis/v1/appointmentUserLogin/listspecialty","apis/v1/appointmentUserLogin/schedule-items", 
						"/appointmentUserLogin/listFollowUp").permitAll()
