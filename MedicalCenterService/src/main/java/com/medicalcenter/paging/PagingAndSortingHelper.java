package com.medicalcenter.paging;
...
import com.medicalcenter.repositories.SearchRepository;
...
public class PagingAndSortingHelper {
	...
	public void listEntitiesStringId(int pageNum, int pageSize, SearchRepository<?, String> repo) {
