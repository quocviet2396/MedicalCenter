...
public class User extends AbstractEntity {
	...
	@Column(length = 5024, nullable = true)
	...
	public User(@Email(message = "Email must be in correct format") String email, @NotNull String password,
			@NotNull String firstName, @NotNull String lastName, String dateOfBirth, Gender gender, String photo,
			Set<Role> roles, Specialty specialty, String informationBackground) {
		super();
		this.email = email;
		...
		this.informationBackground = informationBackground;
	}
